...
<head>
	...
	<!--//fonts-->
			...
			<link rel="stylesheet" href="<?php echo base_url();?>res/frontend/assets/css/font-awesome.css">
            <link rel="icon" type="image/x-icon" href="<?php echo base_url();?>res/frontend/assets/images/android-icon-72x72.png">
	<!-- for-mobile-apps -->
...
<div id="home" class="banner-slider">
	<div class="header">
									<div class="header-left">
										<a class="link link--kumya" href="#"><img src= "images/toplogo.png" alt="" /></a>
									</div>
									<div class="navigation">
										<span class="menu"><img src="<?php echo base_url();?>res/frontend/images/menu.png" alt=""/></span>
												<nav class="cl-effect-11" id="cl-effect-11">	
													<ul class="nav1">	
														...
														<li class="dropdown">
		 <a class="scroll" data-toggle="dropdown" href="#services" data-hover="services">Services <span class="caret"></span></a>
										          <ul class="dropdown-menu">
										            <li><a href="#">Business cards</a></li>
										            <li><a href="#">Note card</a></li>
										            <li><a href="#">Flyers</a></li>
										            <li><a href="#">Brochures</a></li>
										            <li><a href="#">Mini cards</a></li>
					...
					<div class="banner">
							<div class="container">
								<div class="banner-info">
									...
									<a class="scroll" href="#about"><img src="<?php echo base_url();?>res/frontend/images/arrow.png" alt=""/></a>
								</div>
							</div>
					</div>
				</li>
...
<div class="services" id="services">
	<div class="container">
		<div class="sevices-main">
			...
			<div class="col-md-4 ser-grid">
                <img src="<?php echo base_url();?>res/frontend/images/baby.jpg" alt=""/><br><h4><a href="<?php echo base_url();?>index.php/flyers">Flyers</a></h4>
               
            </div>
            <div class="col-md-4 ser-grid">
                <img src="<?php echo base_url();?>res/frontend/images/images.jpg" alt=""/><br><h4><a href="<?php echo base_url();?>index.php/business_cards">Business Cards</a></h4>
               
            </div>
            <div class="col-md-4 ser-grid">
                <img src="<?php echo base_url();?>res/frontend/images/brochures4.jpg" alt=""/><br><h4><a href="<?php echo base_url();?>index.php/brochures">Brochures</a>	</h4> 
	...
	<div class="container">
		<div class="award-grids">
			<!--//div class="col-md-6 award-left"-->
				<!--img src="<?php echo base_url();?>res/frontend/images/img1.jpg" alt=""/-->
			<!--div-->
			<div class="col-md-12 award-middle">
				<h2>WHY INFINITY</h2><br>
				<p>
				...
				<ul id="da-thumbs" class="da-thumbs">
					<li>
						<a href="images/a1.jpg" class="b-link-stripe b-animate-go thickbox">
							<img src="<?php echo base_url();?>res/frontend/images/a1.jpg" alt="" />
							<div>
								<h5>VIEW</h5>
							</div>
						</a>
					...
					<li>
						<a href="images/a2.jpg" class="b-link-stripe b-animate-go thickbox">
							<img src="<?php echo base_url();?>res/frontend/images/a2.jpg" alt="" />
							<div>
								<h5>VIEW</h5>
							</div>
						</a>
					...
					<li>
						<a href="images/a3.jpg" class="b-link-stripe b-animate-go thickbox">
							<img src="<?php echo base_url();?>res/frontend/images/a3.jpg" alt="" />
							<div>
								<h5>VIEW</h5>
							</div>
						</a>
					...
					<li>
						<a href="images/a4.jpg" class="b-link-stripe b-animate-go thickbox">
							<img src="<?php echo base_url();?>res/frontend/images/a4.jpg" alt="" />
							<div>
								<h5>VIEW</h5>
							</div>
						</a>
					...
					<li>	
						<a href="images/a5.jpg" class="b-link-stripe b-animate-go thickbox">
							<img src="<?php echo base_url();?>res/frontend/images/a5.jpg" alt="" />
							<div>
								<h5>VIEW</h5>
							</div>
						</a>
					...
					<li>
						<a href="images/a6.jpg" class="b-link-stripe b-animate-go thickbox">
							<img src="<?php echo base_url();?>res/frontend/images/a6.jpg" alt="" />
							<div>
								<h5>VIEW</h5>
							</div>
						</a>
					...
					<li>
						<a href="images/a7.jpg" class="b-link-stripe b-animate-go thickbox">
							<img src="<?php echo base_url();?>res/frontend/images/a7.jpg" alt="" />
							<div>
								<h5>VIEW</h5>
							</div>
						</a>
...
<div class="contact-us">
		...
		<div class="contact-grids">
			...
			<iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d7977.58750287012!2d36.7905!3d-1.298497!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2ske!4v1447745580273" width="500" height="250" frameborder="0" style="border:0" allowfullscreen></iframe>
