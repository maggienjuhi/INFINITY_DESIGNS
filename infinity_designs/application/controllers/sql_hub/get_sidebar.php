<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
		...
		$data['appmodels'] = $this -> asset_database -> select_multiple_array("SELECT al.applist,al.apptype,al.icon_name,al.app_url,ml.modelslist,ml.icon_name AS model_icon,ml.model_url FROM appmodels am,applist al,modelslist ml,business_applist bal WHERE am.applist_id = al.id AND am.modelslist_id = ml.id AND al.id=bal.applist_id ORDER BY al.position ASC;");
